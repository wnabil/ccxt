...
var pionex$1 = require('./abstract/pionex.js');
...
class pionex extends pionex$1 {
    describe() {
        return this.deepExtend(super.describe(), {
            ...
            'exceptions': {
                'APIKEY_LOST': errors.ArgumentsRequired,
                'SIGNATURE_LOST': errors.ArgumentsRequired,
                'IP_NOT_WHITELISTED': errors.InvalidAddress,
                'INVALIE_APIKEY': errors.AuthenticationError,
                ...
                'TRADE_INVALID_SYMBOL': errors.BadSymbol,
                'TRADE_PARAMETER_ERROR': errors.BadRequest,
                'TRADE_NOT_ENOUGH_MONEY': errors.InsufficientFunds,
                'TRADE_PRICE_FILTER_DENIED': errors.BadRequest,
                'TRADE_SIZE_FILTER_DENIED': errors.BadRequest,
                'TRADE_AMOUNT_FILTER_DENIED': errors.BadRequest,
                'TRADE_REPEAT_CLIENT_ORDER_ID': errors.DuplicateOrderId,
                'TRADE_OPEN_ORDER_EXCEED_LIMIT': errors.DDoSProtection,
                'TRADE_OPERATION_DENIED': errors.PermissionDenied,
                'TRADE_ORDER_NOT_FOUND': errors.OrderNotFound,
                'MARKET_INVALID_SYMBOL': errors.BadSymbol,
            },
        });
    }
    ...
    sign(path, api = 'public', method = 'GET', params = {}, headers = undefined, body = undefined) {
        ...
        if (api === 'private') {
            ...
            const signature = this.hmac(this.encode(structedPath), this.encode(this.secret), sha256.sha256);
            headers = {
