...
use ccxt\abstract\pionex as Exchange;
...
class pionex extends Exchange {
    ...
    public function fetch_tickers(?array $symbols = null, $params = { }): array {
        ...
        $request = $params;
        $response = $this->publicGetMarketTickers ($request);
        // {
        // "data" => {
        //     "tickers" => array(
        //     array(
        ...
        // "timestamp" => 1566691672311
        // }
        $response2 = $this->publicGetMarketBookTickers ($request);
        // {
        // "data" => array(
        //     "tickers" => array(
        //     )
    ...
    public function fetch_ticker(string $symbol, $params = array ()): array {
        ...
        // "timestamp" => 1566691672311
        // }
        $response2 = $this->publicGetMarketBookTickers ($this->extend($request, $params));
        // {
        // "data" => array(
        //     "tickers" => array(
        //     )
    ...
    public function fetch_balance($params = array ()): array {
         ...
         */
        $this->load_markets();
        $response = $this->privateGetAccountBalances ($this->extend($params));
        // {
        // "data" => {
        //     "balances" => array(
        //     array(
    ...
    public function fetch_open_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        $response = $this->privateGetTradeOpenOrders ($this->extend($request, $params));
        // {
        //     "data" => {
        //       "orders":array(
        //         array(
    ...
    public function fetch_order_trades(string $id, ?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        ...
        $response = $this->privateGetTradeFillsByOrderId ($this->extend($request, $params));
        // {
        //     "data" => {
        //       "fills":array(
        //         array(
