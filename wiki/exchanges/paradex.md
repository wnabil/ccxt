...
```javascript
paradex.fetchPositions (symbol[, params])
```
...
```javascript
paradex.watchTrades (symbol[, since, limit, params])
```
...
```javascript
paradex.watchOrderBook (symbol[, limit, params])
```
...
```javascript
paradex.watchTicker (symbol[, params])
```
...
```javascript
paradex.watchTickers (symbols[, params])
```
